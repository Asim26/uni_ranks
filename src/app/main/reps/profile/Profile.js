...
export default function Profile() {
	...
	useEffect(() => {
		fetch(api + 'representatives?userId=' + id).then(res => res.json()).then(results => {
	...
	function handleSubmit(model) {
		fetch(api + 'updateRepPr', { method: 'PUT', body: '{"id": "' + id + '", "name": "' + model.name + '", "pass": "' + model.password + '", "phone": "' + model.phone + '", "email": "' + model.email + '", "title": "' + model.title + '", "address": "' + model.address + '"}', headers: { 'Content-Type': 'application/json' } }).then(res => res.text());
